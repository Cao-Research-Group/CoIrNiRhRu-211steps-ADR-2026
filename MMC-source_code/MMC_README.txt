...
(ii) DecorationMSymCanonicalMidFreezeManager.java: MMC manager, with middle 1 layer fixed and other layers canonical;
...
(v) Sym_equimolar-prim=80.vasp: An initialstructure for example, which is an equimolar 15¡Á16 slab.
